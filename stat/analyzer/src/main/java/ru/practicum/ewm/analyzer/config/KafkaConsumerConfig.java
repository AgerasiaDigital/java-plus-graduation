...
import ru.practicum.ewm.stats.avro.serializer.EventSimilarityAvroDeserializer;
import ru.practicum.ewm.stats.avro.serializer.UserActionAvroDeserializer;
...
public class KafkaConsumerConfig {
    ...
    @Value("${spring.kafka.consumer.group-id-actions}")
    private String actionsGroupId;

    @Value("${spring.kafka.consumer.group-id-similarity}")
