...
import ru.practicum.additional.client.EventsInternalClient;
...
@Primary
@Transactional
public class AdditionalCategoryServiceImpl implements CategoryService {
    private static final Logger log = LoggerFactory.getLogger(AdditionalCategoryServiceImpl.class);

    private final CategoryRepository categoryRepository;
    private final EventsInternalClient eventsInternalClient;

    public AdditionalCategoryServiceImpl(CategoryRepository categoryRepository,
                                          EventsInternalClient eventsInternalClient) {
        this.categoryRepository = categoryRepository;
        this.eventsInternalClient = eventsInternalClient;
    }
    ...
    public void deleteById(Long categoryId) {
        ...
        if (eventsInternalClient.existsByCategory(categoryId)) {
