...
-   **Основной сервис (внешний API):** [`ewm-main-service-spec.json`](ewm-main-service-spec.json)
...
Изначально данный проект был разработан в команде в рамках курса "Java-разработчик" от Яндекс Практикума. Командная работа включала в себя реализацию основного сервиса, сервиса статистики и дополнительной функциональности "Комментарии".

В настоящее время проект развивается как **индивидуальный дипломный проект**. Дальнейшие доработки, рефакторинг и расширение функционала ведутся в рамках данного репозитория.
